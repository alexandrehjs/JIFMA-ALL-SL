                ...
                case 'games':
                    return (
                        <>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                <span
                    className={`px-2 py-1 text-xs font-medium rounded-full ${item.status === 'Finalizado' ? 'bg-green-100 text-green-800' :
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        {data.map((item) => (
                            <tr key={item.news_id || item.game_id || item.team_id || item.sport_id}
                ...
                case 'medal':
                    return (
                        <>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">Medalhas de Prata</label>
                                <input
                                    type="number"
                                    min={0}
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">Medalhas de Bronze</label>
                                <input
                                    type="number"
                                    min={0}
